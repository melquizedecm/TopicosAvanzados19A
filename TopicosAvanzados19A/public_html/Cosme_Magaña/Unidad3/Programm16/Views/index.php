...
<html lang="en" dir="ltr">
  ...
  <body>
    <script>
      ...
      function eliminar(id) { //llama a la otra funcion eliminar que se encuentra en la carpeta controllers
               $.post('../Controllers/user.php',
                       {
                           'id': id,
                           'action': 'eliminar'
      ...
      <tbody>
        ...
        <tr align="center">
          <form onsubmit="editar(this)">
            ...
            <td><input type="submit" value="Editar">-<input type="button" onclick="eliminar('<?php echo $filaUsers[0]; ?>');" value="Eliminar"></td>
          </form>
        </tr>
        <?php
