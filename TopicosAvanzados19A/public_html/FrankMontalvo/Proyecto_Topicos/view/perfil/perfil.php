...
//Jesus Lira
//Cosme Magaña
//Description:php vista del usuario tipo alumno
...
//conexion con la base de datos con el Config.php
...
//asignacion de las variables de la consulta generada en $sql
...
//READ de los eventos correspondientes a la matricula
...
//READ que valida la existencia de una imagen asignada de ser asi reescribe la ruta
...
//validacion de grado y nivel de los datos
...
<div class="input-group">
 ...
 <div class="custom-file">
   <form action="../../controller/PerfilController.php" method="post" enctype="multipart/form-data">
     ...
     <td><strong>Nombre:</strong></td><td> <input type="text" readonly="readonly" name="txtnom" value="<?php echo $matriculay; ?>"></td>
     <strong>Foto:</strong></td>  <td><input type="file" name="foto" id="foto">
...
<br>
                  ...
                  <!--
                  Secciones dentro de la pagina para visualizar
