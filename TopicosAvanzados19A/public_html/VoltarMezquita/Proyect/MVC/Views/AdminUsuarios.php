    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Administrador de usuarios</h2>   <!--subtitulo de la pagina-->
					</div>
					<div class="col-sm-6">
                    ...
                    <tr>
                      <!--imprime los usuarios de la bd-->
                        ...
                        <td>
                            ...
                            <a href="#deleteEmployeeModal" onclick="iduserdel('<?php echo $filaadmin[3]; ?>')" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
                  <?php }} ?>
				...
				<form>
					...
					<div class="modal-body">
						<div class="form-group">
							<label>Usuario</label>
							<input id="adduser" type="text" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Nombre</label>
							<input id="addnomb" type="text" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Apellido Paterno</label>
							<input id="addapp" type="text" class="form-control" required>
						</div>

						<div class="form-group">
							<label>Contraseña</label>
							<input id="addpass" type="text" class="form-control" required>
						</div>

					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
						<input type="button" onclick="agregarUser()" class="btn btn-success" value="Agregar">
					</div>
				</form>
			</div>
		</div>
	...
	<div id="editEmployeeModal" class="modal fade">
		<div class="modal-dialog">
            ...
            <div class="form-group" style="display:none;">
							...
							<input id="editid" type="text" class="form-control" required>
						</div>
            <div class="form-group">
							<label>Usuario</label>
							<input id="editus" type="text" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Nombre</label>
							<input id="editnomb" type="text" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Apellido Paterno</label>
							<input id="editapp" type="text" class="form-control" required>
						</div>

						<div class="form-group">
							<label>Contraseña</label>
							<input id="editpass" type="text" class="form-control" required>
						</div>
					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
						<input type="button" onclick="editarUser()" class="btn btn-info" value="Guardar">
					</div>
				</form>
			</div>
		</div>
	...
	<div id="deleteEmployeeModal" class="modal fade">
		<div class="modal-dialog">
            ...
            <div class="form-group" style="display:none;">
					...
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
						<input type="button" onclick="eliminarUser()" class="btn btn-danger" value="Eliminar">
					</div>
				</form>
			</div>
		</div>
