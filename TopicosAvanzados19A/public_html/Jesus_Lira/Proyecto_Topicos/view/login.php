...
require_once '../Core/Config.php';
  ...
  $sqlusuario="SELECT usuario.matricula, usuario.contrasenia, alumnos.Status FROM usuario,alumnos";
  $tablausuario=$link->query($sqlusuario);
  $sqlusuario2="SELECT usuario2.matricula, usuario2.contrasenia,trabajadores.Status FROM usuario2,trabajadores";
	...
	if(isset($_POST['username'])){
		...
		$contrasena=$_POST["pass"];
			...
			while($filausuario2=$tablausuario2->fetch_array(MYSQLI_BOTH)){
				if($usuario==$filausuario2[0] && $contrasena==$filausuario2[1] &&$filausuario2[2]==1){
					$bandera1=true;
					$tipo=2;
					break;
				}else{
        ...
        $_SESSION['usuario']=$usuario;
         ...
         $_SESSION['usuario']=$usuario;
			 ...
			 if($bandera==false && $bandera1==false){
