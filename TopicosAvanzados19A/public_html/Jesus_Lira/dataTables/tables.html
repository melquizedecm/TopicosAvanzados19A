...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <!--Div Apartado de Alumnos -->
      ...
      <img class="alumnos" src="img/alumnos.png" alt="La imagen no se ha podido Cargar :(" onclick="mostrarAlumn()">
      <h1>Alumnos</h1>
        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                <h2>Base de datos de <b>Alumnos</b></h2>
              </div>
              <div class="col-sm-6">
      ...
      <div class="divMaestros">
          <img class="maestros" src="img/maestros.jpg" alt="La imagen no se ha podido Cargar :(" onclick="mostrarMaes()">
            <h1>Maestros</h1>
              ...
              <div class="container">
                  <div class="table-wrapper">
                      <div class="table-title">
                          <div class="row">
                              <div class="col-sm-6">
                      <h2>Base de datos de <b>Maestros</b></h2>
                    </div>
                    <div class="col-sm-6">
                      ...
                      <a href="#deleteMaestro" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Eliminar</span></a>
                    </div>
                          </div>
                      </div>
                      <table class="table table-striped table-hover">
                          ...
                          <tbody>
                                ...
                                <td></td>
                                <td>
                                    <a href="#editMaestro" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="#deleteMaestro" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                          </tbody>
                      </table>
                <div class="clearfix">
            ...
            <div id="deleteMaestro" class="modal fade">
              ...
              <div class="divTrabajadores">
                <img class="trabajadores" src="img/trabajadores.jpg" alt="La imagen no se ha podido Cargar :(" onclick="mostrarTrab()">
                <h1>Trabajadores</h1>
                  ...
                  <div class="container">
                      <div class="table-wrapper">
                          <div class="table-title">
                              <div class="row">
                                  <div class="col-sm-6">
                          <h2>Base de datos de <b>Trabajadore</b></h2>
                        </div>
                        <div class="col-sm-6">
                          ...
                          <a href="#deleteTrab" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Eliminar</span></a>
                        </div>
                              </div>
                          </div>
                          <table class="table table-striped table-hover">
                              ...
                              <tbody>
                                    ...
                                    <td></td>
                                    <td>
                                        <a href="#editTrab" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a href="#deleteTrab" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                    </td>
                              </tbody>
                          </table>
                    <div class="clearfix">
              ...
              <div class="divPagos">
                <img class="pagos" src="img/pagos.jpg" alt="La imagen no se ha podido Cargar :(" onclick="mostrarPag()">
                <h1>Pagos</h1>
                ...
                <div id="pag" style="display:none;"> <!--Tabla de pagos -->
                    <div class="container">
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-6">
                            <h2>Base de datos de <b>Pagos</b></h2>
                          </div>
                          <div class="col-sm-6">
                            ...
                            <a href="#deletePag" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Eliminar</span></a>
                          </div>
                                </div>
                            </div>
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                      ...
                                      <td></td>
                                      <td>
                                          <a href="#editPag" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                          <a href="#deletePag" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                      </td>
                                </tbody>
                            </table>
                      <div class="clearfix">
                  ...
                  <!-- Edit Modal HTML -->
                  <div id="editPag" class="modal fade">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <form>
                          <div class="modal-header">
              ...
              <div class="divEventos">
                <img class="eventos" src="img/eventos.jpg" alt="La imagen no se ha podido Cargar :(" onclick="mostrarEven()">
                <h1>Eventos</h1>
                    ...
                    <div class="container">
                        <div class="table-wrapper">
                          ...
                          <div class="col-sm-6">
                            ...
                            <a href="#deleteE" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Eliminar</span></a>
                          </div>
                                </div>
                            </div>
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                      ...
                                      <td></td>
                                      <td>
                                          <a href="#editE" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                          <a href="#deleteE" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                      </td>
                                </tbody>
                            </table>
                      <div class="clearfix">
